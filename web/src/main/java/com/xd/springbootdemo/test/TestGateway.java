...
public class TestGateway {
    public static void main(String[] args)throws Exception {
        ...
        String YKD_QueryApplyInfo5 = "{\"head\":{\"corp_code\":\"coopr_01\",\"timestamp\":\"1590025684846\",\"business_code\":\"YKD_QueryApplyInfo\"},\"body\":{\"openId\":\"coopr_01347067691573972992\",\"releaseNo\":\"YKD2020052214504582053\"}}";
        ...
        String mac = MD5.encodeByMd5WithSalt(YKD_QueryApplyInfoList5,"8aa16b3b-fbbd-424e-badf-788ccce0d1b1");
        //String data = AES.encrypt(YKD_QueryApplyInfo, AES.generateKey(Base64.decode("UICKta78ymjw6+JduzkNCg==")));
        String data = AES.encrypt(YKD_QueryApplyInfoList5, AES.generateKey(Base64.decode("B8OevT5wAL94xmRQGVm4Tw==")));
        ...
        String resp = HttpUtil.post("http://127.0.0.1:8083/gateway/accept", params);
